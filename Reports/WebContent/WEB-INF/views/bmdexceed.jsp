...
<div class="row row-cards row-deck">
	      <form class="card" action="bmdexceed" method="post">
                <div class="card-body">
				...
				<tbody>
					<c:forEach var="mtrblc" items="${bmd}" varStatus="tagStatus">
						<tr>
							...
							<td><a href="bmddivision?cir=${mtrblc.CIRCLE}&mon_year=${mon_year}">${mtrblc.CIRCLE}</a></td>
							<td><a href="scscircle?cir=${mtrblc.CIRCLE}&mon_year=${mon_year}">${mtrblc.SCS}</a></td>
			...
			<table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%;">
				...
				<tbody>
					<c:forEach var="mtrblc" items="${division}" varStatus="tagStatus">
						<tr>
							<td>${tagStatus.index + 1}</td>
							<td><a href="bmdsubdivision?div=${mtrblc.DIVNAME}&mon_year=${mon_year}&cir=${circle}">${mtrblc.DIVNAME}</a></td>
							<td><a href="scsdivision?div=${mtrblc.DIVNAME}&mon_year=${mon_year}&cir=${circle}">${mtrblc.SCS}</a></td>
							<td>${mtrblc.PENAL_MD}</td>
							<td>${mtrblc.PENAL_DEMAND_CHARGES}</td>
						</tr>
					</c:forEach>
				...
				<tfoot>
						<tr>
							<th colspan="2" class="text-right">Grand Total</th>
							<th class="text-right"><a href="alldivision?mon_year=${mon_year}&cir=${circle}">${division.stream().map(mtrblc -> mtrblc.SCS).sum()}</a></th>
			...
			<table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%;">
				...
				<tbody>
					<c:forEach var="mtrblc" items="${subdivision}" varStatus="tagStatus">
						<tr>
							<td>${tagStatus.index + 1}</td>
							<td><a href="bmdsection?div=${divisionName}&mon_year=${mon_year}&cir=${circle}&sub=${mtrblc.SUBNAME}">${mtrblc.SUBNAME}</a></td>
							<td><a href="scssubdivision?div=${divisionName}&mon_year=${mon_year}&cir=${circle}&sub=${mtrblc.SUBNAME}">${mtrblc.SCS}</a></td>
							<td>${mtrblc.PENAL_MD}</td>
							<td>${mtrblc.PENAL_DEMAND_CHARGES}</td>
						</tr>
					</c:forEach>
				...
				<tfoot>
						<tr>
							<th colspan="2" class="text-right">Grand Total</th>
							<th class="text-right"><a href="allsubdivision?div=${divisionName}&mon_year=${mon_year}&cir=${circle}&sub=${sub}">${subdivision.stream().map(mtrblc -> mtrblc.SCS).sum()}</a></th>
...
<c:if test="${ not empty fn:trim(section)}">
			...
			<table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%;">
				...
				<tfoot>
						<tr>
							<th colspan="2" class="text-right">Grand Total</th>
							<th class="text-right"><a href="allsections?div=${divisionName}&mon_year=${mon_year}&cir=${circle}&sub=${sub}">${section.stream().map(mtrblc -> mtrblc.SCS).sum()}</a></th>
