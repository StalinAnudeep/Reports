...
<div class="row row-cards row-deck">
		<form class="card" action="ACDAbstract" method="post">
			<div class="card-body">
				<h3 class="card-title"><strong><span class="text-danger">HT37A</span> - ACD Notices Issued Abstract</strong> </h3>
				<div class="row">
				<div class="col-md-3">
							...
							<c:forEach var="mtrblc" items="${tp}" varStatus="tagStatus">
								...
								<tr class="${mtrblc.CIRCLE}">
									...
									<c:if test="${mtrblc.CTCAT eq 'TOTAL'}">
										...
										<td class="text-right TOTAL bg-primary"
											style="padding-left: 5px;">${mtrblc.ISD_ADJ}</td>
											<td class="text-right TOTAL bg-primary"
											style="padding-left: 5px;">${mtrblc.ACD_BAL_PAY}</td>
											<%-- <td class="text-right TOTAL bg-primary"
									...
									<c:if test="${mtrblc.CTCAT ne 'TOTAL'}">
										...
										<td class="text-right" style="padding-left: 5px;">${mtrblc.ISD_ADJ}</td>
										<td class="text-right" style="padding-left: 5px;">${mtrblc.ACD_BAL_PAY}</td>
