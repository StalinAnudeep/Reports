...
<div class="row row-cards row-deck">
	<form class="card" action="DemandReport" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT10</span> - Demand report</strong></h3>
			<div class="row">
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label class="form-label">GET DemandReport</label>
						<button type="submit" class="btn btn-success">GET DemandReport</button>
					</div>
				</div>
			</div>
		</div>
					...
					<tbody>
						<c:forEach var="mtrblc" items="${cdmd}" varStatus="tagStatus">
							<tr>
								...
								<td class="text-right">${mtrblc.BTSCNO}</td>
								<td class="text-right">${mtrblc.BTCURDEM}</td>
								<td class="text-right">${mtrblc.WC_BTCURDEM}</td>
							</tr>
						</c:forEach>
					</tbody>
					<tfoot>
