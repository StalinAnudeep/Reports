...
<div class="row row-cards row-deck">
		<form class="card" action="DCSectionWiseReport" method="post">
			<div class="card-body">
				<h3 class="card-title"><strong><span class="text-danger">HT04A</span> - Section Wise Daily Collection Report </strong></h3>
				<div class="row">
				<div class="col-md-4">
					...
					<table id="tbl_exporttable_to_xls"
						...
						<tbody>
							...
							<c:forEach var="mtrblc" items="${tp}" varStatus="tagStatus">
								...
								<c:set var="divtype" value="${mtrblc.DIV_TYPE}" scope="request" />
							...
							<%-- 		<td >${mtrblc.TYPE}</td>
									...
									<c:if test="${mtrblc.DIVNAME eq 'TOTAL' && mtrblc.SECNAME eq 'TOTAL'}">
									<td class="text-center bg-primary TOTAL_HD" style="padding-left: 5px;">${mtrblc.CIRNAME}</td>
									</c:if>
									<c:if test="${mtrblc.DIVNAME ne 'TOTAL' && mtrblc.SECNAME ne 'TOTAL'}">
									<td  class="text-center" style="padding-left: 5px;">${mtrblc.DIVNAME}</td>
									</c:if> --%>
									...
									<fmt:parseNumber value="${mtrblc.ARREAR_COLLECTED}" var="a" scope="request"/>
										...
										String s2 = df.format(tot==0?0:per);
									...
									<c:if test="${mtrblc.SECNAME eq 'TOTAL' && mtrblc.DIVNAME ne 'TOTAL'}">
									<td class="  "
											style="padding-left: 5px;">${mtrblc.TYPE}</td>
											<td class=" "
											style="padding-left: 5px;">${mtrblc.CIRNAME}</td>
									<td class=" TOTAL_HD bg-success"
											style="padding-left: 5px;">${mtrblc.DIVNAME}</td>
											<td class=" TOTAL_HD bg-success"
											style="padding-left: 5px;">${mtrblc.SECNAME}</td>
										 <td class="text-right TOTAL_HD bg-success"
											style="padding-left: 5px;">${mtrblc.NOS}</td>
										<td class="text-right TOTAL_HD bg-success"
											style="padding-left: 5px;">${mtrblc.CURR_DEMAND}</td>
										<td class="text-right TOTAL_HD bg-success"
									...
									<c:if test="${mtrblc.DIVNAME ne 'TOTAL' && mtrblc.SECNAME ne 'TOTAL'}">
										...
										<td style="padding-left: 5px;">${mtrblc.SECNAME}</td>
