...
<div class="row row-cards row-deck">
	<form class="card" action="HtSales" method="post">
		<div class="card-body">
			<h3 class="card-title">
<strong><span class="text-danger">HT02</span> - HT Sales(Transco)</strong></h3>
			<div class="row">
				<div class="col-md-4">
				...
				<div class="col-md-4">
					<div class="form-group">
						<label class="form-label">GET HT Sales</label>
				...
				<table
					...
					<thead>
						<tr>
							...
							<th class="text-right">REC_UNITS</th>
							<th class="text-right">BILLED_UNITS</th>
