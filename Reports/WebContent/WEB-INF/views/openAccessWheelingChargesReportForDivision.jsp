...
<div class="row row-cards row-deck">
	...
	<c:if test="${ not empty fn:trim(wheelingChargesDivisionDetails)}">
		<div class="card ">
			<div
				...
				<table
					...
					<thead>
						<tr class="bg-primary text-white text-center">
							<th class="text-white" rowspan="2" style="vertical-align: middle;">S.NO</th>
							<th class="text-white" rowspan="2" style="vertical-align: middle;">DIVISION</th>
					...
					<tbody>
						<c:forEach var="mtrblc" items="${wheelingChargesDivisionDetails}"
							varStatus="tagStatus">
							<tr style="font-weight: 500;">
								...
								<c:forEach items="${mtrblc}" var="entry">
									...
									<td class="text-right"><a
										href="openAccessWheelingChargesReportSubDivision?div=${mtrblc.DIVNAME}&fyear=${year}">${entry.value}</a></td>
									<%
									s++;
									} else {
									%>
