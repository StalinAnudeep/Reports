...
<div class="row row-cards row-deck">
	<form class="card" action="hodwiseabstract" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT97B</span> - Department Wise DCB Abstract</strong></h3>
			<div class="row">
  <div class="col-md-2">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label class="form-label">GET HOD Wise Abstract</label>
						<button type="submit" class="btn btn-success">GET HOD Wise Abstract</button>
					</div>
				</div>
			</div>
		</div>
				...
				<table id="multiLevelTable"
					...
					<tr>
						...
						<tr>
							...
							<th rowspan="2" style="vertical-align: middle;">DEPTCODE</th>
							<th rowspan="2" style="vertical-align: middle;">DEPT NAME</th>	
