...
<div class="row row-cards row-deck">
	<form class="card" action="sectionWiseDemand" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT25</span> - Section Wise Split Demand Report</strong></h3>
			<div class="row">
				<div class="col-md-3">
...
<script>
	require([  'jquery','datatables.net','datatables.net-jszip','datatables.net-buttons','datatables.net-buttons-flash','datatables.net-buttons-html5'], function($,datatable,jszip ) {
		...
		$('.datatable').DataTable({
	        ...
	        buttons: {
	            buttons: [
	                { extend: 'csv', className: 'btn btn-xs btn-primary',title: 'SectionWiseSplitDemandReport',footer: true },
	                { extend: 'excel', className: 'btn btn-xs btn-primary',title:'SectionWiseSplitDemandReport',footer: true }
	            ]
	        }
	    });
	});
