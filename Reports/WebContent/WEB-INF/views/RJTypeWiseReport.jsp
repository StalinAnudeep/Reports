...
<div class="row row-cards row-deck">
	<form class="card" action="RJTypeWiseReport" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT12A</span> - RJ Type Wise Abstract</strong></h3>
			<div class="row">
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<button type="submit" class="btn btn-success">GET RJ Type Abstract</button>
					</div>
				</div>
			</div>
		</div>
