...
<div class="row row-cards row-deck">
	<form class="card" action="cmdca" method="post">
		<div class="card-body">
			<h3 class="card-title">Section Wise , Category Wise DCB Report </h3>
			<div class="row">
				<div class="col-md-3">
				...
				<table
					...
					<thead>
						<tr>
							...
							<th>STATUS</th>
							<th>NOS</th>
							<th>OB OTHERTHAN COURT</th>
							<th>OB COURT</th>
							<th>TOT_OB</th>
							<th>DEMAND WITHOUT COURT</th>
							<th>COURT LPC</th>
							<th>DR RJ</th>
							<th>CR RJ</th>
							<th>COURT RJ</th>
							<th>COLLECTION</th>
							<th>CB OTHERTHAN COURT</th>
							<th>CB COURT</th>
							<th>TOTAL CB</th>
					...
					<tbody>
						<c:forEach var="mtrblc" items="${acd}" varStatus="tagStatus">
							<tr>
								...
								<td class="text-right">${mtrblc.DR_RJ}</td>
								<td class="text-right">${mtrblc.CR_RJ}</td>
