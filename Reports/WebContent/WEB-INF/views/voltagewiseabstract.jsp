...
<div class="row row-cards row-deck">
	<form class="card" action="voltagewiseabstract"" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT102</span> - Voltage Wise DCB Abstract</strong></h3>
			<div class="row">
  <div class="col-md-2">
				...
				<div class="col-md-2">
                      <div class="form-group">
                        ...
                        <select class="form-control"  id="voltage" name="voltage" required="required">
				...
				<div class="col-md-2">
					<div class="form-group">
						...
						<button type="submit" class="btn btn-success">GET Voltage Wise Abstract</button>
					</div>
				</div>
			</div>
		</div>
