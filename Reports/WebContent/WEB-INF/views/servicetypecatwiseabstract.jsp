...
<div class="row row-cards row-deck">
	<form class="card" action="servicetypecatwiseabstract" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT100B</span> - Service Type, Category Wise DCB Abstract</strong></h3>
			<div class="row">
  <div class="col-md-2">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label class="form-label">GET Service Type, Cat Wise Abstract</label>
						<button type="submit" class="btn btn-success">GET Service Type, Cat Wise Abstract</button>
					</div>
				</div>
			</div>
		</div>
