...
<div class="row row-cards row-deck">
		<form class="card" action="CollectionAbstract" method="post">
			<div class="card-body">
				<h3 class="card-title"><strong><span class="text-danger">HT104</span> - Collection Abstract </strong></h3>
				<div class="row">
				<div class="col-md-4">
			...
			<!-- 	<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="form-label">Get Collection Abstract </label>
							<button type="submit" class="btn btn-success">Get Collection Abstract </button>
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							...
							<c:forEach var="mtrblc" items="${tp}" varStatus="tagStatus">
								...
								<tr class="${mtrblc.CIRCLE}">
									...
									%>
									<td rowspan="${CIRCOUNT[cirl]}"  class="text-center">${mtrblc.CIRCLE}</td>
									<%
										}
