...
<div class="row row-cards row-deck">
	...
	<c:if test="${ not empty fn:trim(divisionSalesDetails)}">
		<div class="card ">
			<div
					...
					<table id="multiLevelTable"
						...
						<thead class="bg-primary">
							<tr class="bg-primary text-light">
								<th class="text-center text-light">DIVISION</th>
						...
						<tbody>
							...
							String circletype = "S";
							%>
							<c:forEach var="sd" items="${divisionSalesDetails}"
								varStatus="tagStatus">
								<c:set var="cirl" value="${sd.DIVNAME}" scope="request" />
								<tr style="font-weight: 500;">
									<%
									if (!cricle.equals((String) request.getAttribute("cirl"))) {
									%>
									<td rowspan="${CIRCOUNT[cirl]}" class="text-center"><a
										href="fySalesReportForSubDivision?division=${sd.DIVNAME}&fy_year=${fy_year}">${sd.DIVNAME}</a></td>
									<%
									}
