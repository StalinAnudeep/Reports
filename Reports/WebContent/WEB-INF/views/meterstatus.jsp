...
<div class="row row-cards row-deck">
		<form class="card" action="meterstatus" method="post">
			<div class="card-body">
				<h3 class="card-title"><strong><span class="text-danger">HT02F</span>- Metering Status Month Wise Report</strong></h3>
				<div class="row">
				    <div class="col-md-2">
					...
					<div class="col-md-5">
						<div class="form-group">
							<label class="form-label">GET Meter Status Report</label>
							<button type="submit" class="btn btn-success">Get Meter Status Report</button>
						</div>
					</div>
				</div>
			</div>
