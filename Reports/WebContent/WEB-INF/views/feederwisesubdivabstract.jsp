...
<div class="row row-cards row-deck">
	<form class="card" action="feederwisesubdivabstract" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT103A</span> - Feeder Wise ,Sub-Division Wise DCB Abstract</strong></h3>
			<div class="row">
  <div class="col-md-2">
	...
	.change(
			function() {
				...
				$
						.ajax({
							type : 'GET',
							url : "${pageContext.request.contextPath}/getdivision/"+ circle,
	...
	.change(
			function() {
				...
				$
						.ajax({
							type : 'GET',
							url : "${pageContext.request.contextPath}/getsubdivision/"+ division,
							contentType : "application/json;charset=utf-8",
							success : function(data) {
