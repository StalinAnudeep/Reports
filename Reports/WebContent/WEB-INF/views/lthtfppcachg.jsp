...
<div class="row row-cards row-deck">
	      <form class="card" action="lthtfppcachg" method="post">
                <div class="card-body">
                  <h3 class="card-title"><strong><span class="text-danger">HT117</span>  LT - HT Service Wise FPPCA Charges (2021-2022) </strong></h3>
                  <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="form-label">GET Service Wise FPPCA Up Charges</label>
