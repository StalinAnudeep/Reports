...
<div class="row row-cards row-deck">
	<form class="card" action="ServTypeCollection" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT105</span> - Service Type Collection Abstract</strong></h3>
			<div class="row">
				<div class="col-md-3">
...
<%-- 								<td  class="text-center">${mtrblc.NOS}</td> --%>
								<td id="fd" class="text-center"><a href="services?servtype=${mtrblc.CTSERVTYPE}&monyear=${monyear}&circle=${circle}&flag=S&page=SC&type=${mtrblc.STDESC}" target="_blank">${mtrblc.NOS}</a></td>
					...
					<tfoot>
						<tr>
							...
							<th id="fd"  class="text-center"><a href="services?servtype=${mtrblc.CTSERVTYPE}&monyear=${monyear}&circle=${circle}&flag=TOT&page=SC&type=ALL" target="_blank">${cdmd.stream().map(mtrblc -> mtrblc.NOS).sum()}</a></th>
