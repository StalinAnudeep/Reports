				...
				<div class="row">
					...
					<div class="col-md-2">
						<div class="text-right">
							<form class="card" action="serviceTypesubdivabstract" method="post"
								id="form">
								<input type="hidden" value='${fcircle}' name="circle" id="circle">
								<input type="hidden" value='${fservice}' name="servicetype"
									id="servicetype"> <input type="hidden"
									value='${month}' name="month" id="mon">
