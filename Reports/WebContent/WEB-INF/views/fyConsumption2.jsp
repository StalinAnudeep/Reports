...
<div class="row row-cards row-deck">
	<form class="card" action="fyConsumption2" method="post">
		<div class="card-body">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label class="form-label">From Year</label> <select id="fyear"
							class="form-control" name="fyear" required="required">
				...
				<div class="col-md-2">
					<div class="form-group">
						<label class="form-label">To Year</label> <select id="tyear"
							class="form-control" name="tyear" required="required">
							<option value="">Select Year</option>
						</select>
					</div>
				</div>
	...
	<c:if test="${ not empty fn:trim(consumptionDetails)}">
		<div class="card ">
			<div
						...
						<table id="multiLevelTable"
							...
							<thead>
								<tr class="bg-primary text-white text-center">
									<th class="text-center" rowspan="2">Financial Year</th>
							...
							<tbody>
								...
								<c:forEach var="frc" items="${consumptionDetails}"
									...
									<tr class="${frc.CIRCLE}" style = "font-weight : 500;">
										...
										%>
										<td rowspan="${CIRCOUNT[cirl]}">${frc.FINANCIAL_YEAR}</td>
										<%
										}
...
<script>
	requirejs([ 'jquery' ], function($) {
		...
		for (var j = currentYear; j > 2018; j--) {
