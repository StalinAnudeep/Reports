...
<div class="row row-cards row-deck">
	...
	<form class="card" action="journalhistory" method="post" id="form">
		<div class="card-body">
			<h3 class="card-title">
				<strong><span class="text-danger">HT113</span> -  RJ History </strong>
			</h3>
			<div class="row">
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<div class="form-group">
						...
						<button type="submit" class="btn btn-success">Get RJ's History</button>
					</div>
				</div>
			</div>
		</div>
			...
			<table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%;">
				<thead>
					<tr>
						...
						<th class="text-center">RJ TYPE</th>
						<th class="text-center">RJ NO</th>
						<th class="text-center">RJ DATE</th>
						<th class="text-center">CREDIT AMT</th>
						<th class="text-center">DEBIT AMT</th>
						<th class="text-center">KVAH UNITS</th>
				...
				<tbody>
					<c:forEach var="mtrblc" items="${account}" varStatus="tagStatus">
						<tr>
							...
							<td class="text-center">${mtrblc.RJ_TYPE}</td>
									<td class="text-center">${mtrblc.RJ_NO}</td>
									<td class="text-center">${mtrblc.RJ_DATE}</td>
									<td class="text-right">${mtrblc.CR_AMT}</td>
									<td class="text-right">${mtrblc.DR_AMT}</td>
									<td class="text-right">${mtrblc.KVAH_UNITS}</td>
									<td class="text-left">${mtrblc.COMMENTS}</td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
