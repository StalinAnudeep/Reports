...
<div class="row row-cards row-deck">
	      <form class="card" action="lthttrueupchg" method="post">
                <div class="card-body">
                  <h3 class="card-title"><strong><span class="text-danger">HT120</span>  LT - HT Service Wise True Up Charges (2014 -2019) </strong></h3>
                  <div class="row">
                    <div class="col-md-4">
					...
					<c:forEach var="mtrblc" items="${trueup}"  varStatus="tagStatus">
							<tr>
						       <td>${tagStatus.index + 1}</td>
								...
								<td>${mtrblc.LT_USCNO}</td>
								<td>${mtrblc.CAT}</td>
								<td class="text-right">${mtrblc.TOT_UNITS}</td>
								<td class="text-center">0.22</td>
								<td class="text-right">${mtrblc.TOT_AMOUNT}</td>
								<td  class="text-center">36</td>
								<td class="text-right">${mtrblc.TRUEUP_PERMONTH}</td>
								<td>${mtrblc.STATUS}</td>
							</tr>
					</c:forEach>
				</tbody>
