...
<div class="row row-cards row-deck">
		<form class="card" action="TrueUpCollection" method="post">
			<div class="card-body">
				<h3 class="card-title"><strong><span class="text-danger">HT99</span> - True-Up Charges DCB  </strong></h3>
				<div class="row">
				<div class="col-md-4">
				...
				<div class="col-md-4">
					...
					<div class="col-md-4">
						<div class="form-group">
							<label class="form-label">Get True-Up DCB </label>
							<button type="submit" class="btn btn-success">Get True-Up DCB </button>
						</div>
					</div>
				</div>
			</div>
					...
					<table id="multiLevelTable"
						...
						<thead>
							...
							<tr class="bg-primary text-white text-center">
								...
								<c:forEach var="month" items="${MONTH}" varStatus="tagStatus">
								<th colspan="5"><c:out value="${month}"/></th>
								</c:forEach>
