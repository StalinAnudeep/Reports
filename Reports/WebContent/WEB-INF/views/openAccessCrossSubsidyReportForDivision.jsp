...
<div class="row row-cards row-deck">
	...
	<c:if test="${ not empty fn:trim(crossSubsidyDivisionDetails)}">
		<div class="card ">
			<div
				...
				<table
					...
					<tbody>
						<c:forEach var="mtrblc" items="${crossSubsidyDivisionDetails}"
							varStatus="tagStatus">
							<tr style="font-weight: 500;">
								...
								<c:forEach items="${mtrblc}" var="entry">
									...
									<td class="text-right"><a
										href="openAccessCrossSubsidyReportSubDivision?div=${mtrblc.DIVNAME}&fyear=${year}">${entry.value}</a></td>
									<%
									s++;
									} else {
									%>
