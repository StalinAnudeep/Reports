...
<div class="row row-cards row-deck">
	...
	<c:if test="${ not empty fn:trim(subDivisionSalesDetails)}">
		<div class="card ">
			<div
					...
					<table id="multiLevelTable"
						...
						<thead class="bg-primary">
							<tr class="bg-primary text-light">
								<th class="text-center text-light">SUBDIVISION</th>
							...
							<c:forEach var="sd" items="${subDivisionSalesDetails}" varStatus="tagStatus">
								...
								<tr style="font-weight: 500;">
									...
									<td rowspan="${CIRCOUNT[cirl]}" class="text-center"><a
										href="fySalesReportForSection?subDivision=${sd.SUBNAME}&fy_year=${fy_year}">${sd.SUBNAME}</a></td>
									<%
									}
