...
<div class="row row-cards row-deck">
	<form class="card" action="acdReport" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT37</span> - ACD Details</strong> </h3>
			<div class="row">
				<div class="col-md-3">
			...
			<table class="table card-table table-vcenter text-nowrap datatable display" style="width: 100%;">
					<thead>
						<tr>
							...
							<th class="text-right">True up<br> Charges</th>
							<th class="text-right">FPPCA-I</th>
							<th class="text-right">FPPCA-II</th>
							<th class="text-right">ISD Adjustment</th>
					...
					<tbody>
						<c:forEach var="mtrblc" items="${basic}"  varStatus="tagStatus">
							<tr>
								...
								<td class="text-right">${mtrblc.TRUE_UP_CHG}</td>
								<td class="text-right">${mtrblc.FPPCA_CHG}</td>
								<td class="text-right">${mtrblc.FPPCA_CHG_P}</td>
								<td class="text-right">${mtrblc.ISD_ADJ}</td>
