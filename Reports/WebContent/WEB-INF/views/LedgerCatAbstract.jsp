...
<div class="row row-cards row-deck">
		<form class="card" action="catcbledgerabs" method="post">
			<div class="card-body">
				<h3 class="card-title"><strong> <span class="text-danger">HT92B</span> - Category Wise Ledger Closing Balance Category Wise Abstract </strong></h3>
				<div class="row">
				<div class="col-md-3">
						...
						<tbody>
							...
							<c:forEach var="mtrblc" items="${tp}" varStatus="tagStatus">
								...
								<tr class="${mtrblc.CIRCLE}">
									...
									<td rowspan="${CIRCOUNT[cirl]}"><a href="divisionwisecatcbledgerabs?cir=${mtrblc.CIRCLE}&mon_year=${mon}&status=${status}">${mtrblc.CIRCLE}</a></td>
									<%
										}
