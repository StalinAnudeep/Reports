...
<div class="row row-cards row-deck">
	<form class="card" action="CMDHtCatStatusWiseServicesWithLoad"
		method="post">
		<div class="card-body">
			<h3 class="card-title">
			...
			<div
				...
				<table id="multiLevelTable"
					...
					<thead>
						...
						<!-- 	<th class="text-center bg-info" colspan="12">TOTAL</th> -->
						...
						<!-- 	<th class="text-center" colspan="3">BILL STOP</th>
							...
							<th class="text-center bg-info" colspan="3">BILL STOP</th>
							<th class="text-center bg-info" colspan="3">LIVE</th>
							<th class="text-center bg-info" colspan="3">UDC</th>
							<th class="text-center bg-info" colspan="3">TOTAL</th>
						</tr>
						<tr class="bg-primary">
							...
							<th data-orderable="false" class="text-center bg-info">NOS</th>
							<th data-orderable="false" class="text-center bg-info">LOAD</th>
							<th data-orderable="false" class="text-center bg-info">CB</th>
							...
							<th class="text-center  bg-info " data-orderable="false">NOS</th>
							<th class="text-center  bg-info " data-orderable="false">LOAD</th>
							<th data-orderable="false" class="text-center bg-info">CB</th>
					...
					<tbody>
						<c:forEach var="mtrblc" items="${cdmd}" varStatus="tagStatus">
							...
							<%-- 	<td class="text-right">${mtrblc.HT1_BS_NOS}</td>
								...
								<td class="text-right "><strong>${mtrblc.BS_NOS_TOT}</strong></td>
								<td class="text-right "><strong>${mtrblc.BS_LOAD_TOT}</strong></td>
								<td class="text-right "><strong>${mtrblc.BS_CB_TOT}</strong></td>

								<td class="text-right "><strong>${mtrblc.LIVE_NOS_TOT}</strong></td>
								<td class="text-right "><strong>${mtrblc.LIVE_LOAD_TOT}</strong></td>
								<td class="text-right "><strong>${mtrblc.LIVE_CB_TOT}</strong></td>

								<td class="text-right "><strong>${mtrblc.UDC_NOS_TOT}</strong></td>
								<td class="text-right "><strong>${mtrblc.UDC_LOAD_TOT}</strong></td>
								<td class="text-right "><strong>${mtrblc.UDC_CB_TOT}</strong></td>

								<td class="text-right "><strong>${mtrblc.NOS_TOT}</strong></td>
								<td class="text-right "><strong>${mtrblc.LOAD_TOT}</strong></td>
								<td class="text-right "><strong>${mtrblc.CB_TOT}</strong></td>
