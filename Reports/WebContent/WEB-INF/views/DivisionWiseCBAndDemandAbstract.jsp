...
<div class="row row-cards row-deck">
		...
		<c:if test="${ not empty fn:trim(tp)}">
		    ...
		    <div class="card-body row-no-padding table-responsive-sm dataTables_wrapper">
		      <div class="row">
		    <div class="col-md-12">
		     <a href="CBAndDemandAbstract" class="btn btn-primary">Back</a>
		     </div>
		     </div>
			...
			<table id="multiLevelTable" class="table table-sm card-table table-vcenter text-nowrap datatable display dataTable no-footer" style="width: 100%;">
						...
						String circletype="S";%>
							...
							<c:set var="cirltype" value="${mtrblc.CIR_TYPE}" scope="request"/>
								...
								%>
								<td rowspan="${CIRCOUNT[cirl]}"><a href="SubDivisionWiseCBAndDemandAbstract?cir=${mtrblc.CIRNAME}&mon_year=${mon}"><strong> <c:if
