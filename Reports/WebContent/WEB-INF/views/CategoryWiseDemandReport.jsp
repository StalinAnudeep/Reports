...
<div class="row row-cards row-deck">
		<form class="card" action="CategoryWiseDemandReport" method="post">
			<div class="card-body">
				<h3 class="card-title"><strong><span class="text-danger">HT08</span> - Category Wise Demand Abstract </strong></h3>
				<div class="row">
				<div class="col-md-3">
				...
				<div class="col-md-3">
					...
					<div class="col-md-3">
						<div class="form-group">
							<label class="form-label">Get Demand Abstract </label>
							<button type="submit" class="btn btn-success">Get Demand Abstract </button>
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							...
							<c:forEach var="mtrblc" items="${tp}" varStatus="tagStatus">
								...
								<tr class="${mtrblc.CIRCLE}">
									...
									%>
									<td rowspan="${CIRCOUNT[cirl]}"><a href="CategoryWiseDivisionWiseDemandReport?cir=${mtrblc.CIRCLE}&mon_year=${mon}&type=cir&div=0&sub=0&sec=0">${mtrblc.CIRCLE}</a></td>
									<%
										}
