...
<div class="row row-cards row-deck">
	<form class="card" action="RJHODWiseReport" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT12A</span> - RJ HOD Wise Abstract</strong></h3>
			<div class="row">
				<div class="col-md-3">
			...
			<table class="table card-table table-vcenter text-nowrap datatable display" style="width: 100%;">
					...
					<tfoot>
						...
						<c:if test="${circle eq 'ALL'}">
							...
							<th class="text-center">${cdmd.stream().map(mtrblc -> mtrblc.NOS).sum()}</th>
