...
<div class="row row-cards row-deck">
	<form class="card" action="RJServiceWiseReport" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT12</span> - RJ Service Wise Report</strong></h3>
			<div class="row">
				<div class="col-md-3">
				...
				<div class="col-md-3">
					<div class="form-group">
						<label class="form-label">GET RJ Report</label>
						<button type="submit" class="btn btn-success">GET RJ Report</button>
					</div>
				</div>
			</div>
		</div>
			...
			<table class="table card-table table-vcenter text-nowrap datatable display" style="width: 100%;">
					<thead>
						<tr>
							...
							<th class="text-right">RJ TYPE</th>
					...
					<tbody>
						<c:forEach var="mtrblc" items="${cdmd}" varStatus="tagStatus">
							<tr>
								...
								<td>${mtrblc.CIR}</td>
								<td class="text-right">${mtrblc.SCNO}</td>
								<td class="text-right">${mtrblc.RJ_TYPE}</td>
...
<script>
	require([  'jquery','datatables.net','datatables.net-jszip','datatables.net-buttons','datatables.net-buttons-flash','datatables.net-buttons-html5'], function($,datatable,jszip ) {
		...
		$('.datatable').DataTable({
	        ...
	        buttons: {
	            buttons: [
	                { extend: 'csv', className: 'btn btn-xs btn-primary',title: 'RJ Service Wise Report',footer: true },
	                { extend: 'excel', className: 'btn btn-xs btn-primary',title: 'RJ Service Wise Report',footer: true }
	            ]
	        }
	    });
	});
