...
<div class="row row-cards row-deck">
	<form class="card" action="energysalesoamw" method="post">
		<div class="card-body">
			<h3 class="card-title"><strong><span class="text-danger">HT93-B</span> -Energy Audit Sales Report Open Access 30% Month Wise </strong></h3>
			<div class="row">
				<div class="col-md-3">
