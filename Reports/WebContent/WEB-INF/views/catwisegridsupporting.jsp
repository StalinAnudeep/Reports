...
<div class="row row-cards row-deck">
		<form class="card" action="catwisegridsupporting" method="post">
			<div class="card-body">
				<h3 class="card-title"><strong><span class="text-danger">HT110A</span> Category Wise Grid Supporting Monthly Charges Details</strong></h3>
				<div class="row">
				    <div class="col-md-3">
		...
		<c:if test="${ not empty fn:trim(circle)}">
		    ...
		    <h3 class="card-title text-center"><strong>Category Wise Grid Supporting Charges</strong></h3>
		    <hr>
			<table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%;">
			<caption>Category Wise Grid Supporting Charges</caption>
						<thead>
							<tr>
								<th>S.NO</th>
								<th>CIRCLE</th>
						...
						<tr>
							...
							<th class="text-right">${circle.stream().map(mtrblc -> mtrblc.BT_GS_CHG).sum()}</th>
						</tr>
						</tfoot>
					</table>
				</div>
