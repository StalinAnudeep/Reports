					...
					<table class="table card-table table-vcenter text-nowrap datatable display"
						...
						<th colspan="4" class="bg-danger text-center text-white">Court CC_Charges</th>
							...
							<tr>
								...
								<th  class="align-middle text-center text-success">CMD</th>
								<th  class="align-middle text-center text-success">REC_MD</th>
								<th  class="align-middle text-center text-success">BMD</th>
								<th  class="align-middle text-center text-danger">OB_EC</th>
								<th  class="align-middle text-center text-danger">OB_ED</th>
								<th  class="align-middle text-center text-danger">OB_LPC</th>
								<th  class="align-middle text-center text-danger">OB_EDI</th>
								<th  class="align-middle text-center text-danger">OB_TUPC</th>
								<th  class="align-middle text-center text-danger">OB_OLD_FPP</th>
								<th  class="align-middle text-center text-danger">OB_NEW_FPP</th>
								<th  class="align-middle text-center text-danger">OB_FSA</th>
								<th  class="align-middle text-center text-danger">TOT_OB</th>
								<th  class="align-middle text-center text-warning">EC</th>
								<th  class="align-middle text-center text-warning">LPC</th>
								<th  class="align-middle text-center text-warning">ED</th>
								<th  class="align-middle text-center text-warning">EDI</th>
								<th  class="align-middle text-center text-warning">TUPC</th>
								<th  class="align-middle text-center text-warning">OLD_FPP</th>
								<th  class="align-middle text-center text-warning">NEW_FPP</th>
								<th  class="align-middle text-center text-warning">FSA</th>
								<th  class="align-middle text-center text-warning">CMD</th>
								<th  class="align-middle text-center text-info">DRJ_EC</th>
								<th  class="align-middle text-center text-info">DRJ_ED</th>
								<th  class="align-middle text-center text-info">DRJ_LPC</th>
								<th  class="align-middle text-center text-info">DRJ_IED</th>
								<th  class="align-middle text-center text-info">DRJ_FSA</th>
								<th  class="align-middle text-center text-info">DRJ TRUE_UP</th>
								<th  class="align-middle text-center text-info">FPPCA-1</th>
								<th  class="align-middle text-center text-info">FPPCA-2</th>
								<th  class="align-middle text-center text-info">Total_DRJ</th>
								...
								<th  class="align-middle text-center text-success">PAID_EC</th>
								<th  class="align-middle text-center text-success">PAID_ED</th>
								<th  class="align-middle text-center text-success">PAID_LPC</th>
								<th  class="align-middle text-center text-success">PAID_EDI</th>
								<th  class="align-middle text-center text-success">PAID_FSA</th>
								<th  class="align-middle text-center text-success">PAID_TUPC</th>
								<th  class="align-middle text-center text-success">FPPCA-1</th>
								<th  class="align-middle text-center text-success">FPPCA-2</th>
								<th  class="align-middle text-center text-success">PAID_FSA</th>
								<th  class="align-middle text-center text-success">TOT_PAY</th>
								<th  class="align-middle text-center text-danger" >CB_EC</th>
								<th  class="align-middle text-center text-danger">CB_LPC</th>
								<th  class="align-middle text-center text-danger">CB_ED</th>
								<th  class="align-middle text-center text-danger">CB_IED</th>
								<th  class="align-middle text-center text-danger">CB_FSA</th>
								<th  class="align-middle text-center text-danger">CB_TUPC</th>
								<th  class="align-middle text-center text-danger">CB_OLD_FPP</th>
								<th  class="align-middle text-center text-danger">CB_NEW_FPP</th>
								<th  class="align-middle text-center text-danger">CBTOT</th>
								<th  class="align-middle text-center text-warning">OB_SD</th>
								<th  class="align-middle text-center text-warning">PAID_SD</th>
								<th  class="align-middle text-center text-warning">DRJ_SD</th>
								<th  class="align-middle text-center text-warning">CRJ_SD</th>
								<th  class="align-middle text-center text-warning">CB_SD</th>
								<th  class="align-middle text-center text-info">OB_TUPC</th>
								<th  class="align-middle text-center text-info">TUPC</th>
								<th  class="align-middle text-center text-info">DRJ_TUPC</th>
								<th  class="align-middle text-center text-info">CRJ_TUPC</th>
								<th  class="align-middle text-center text-info">PAID_TUPC</th>
								<th  class="align-middle text-center text-info">CB_TUPC</th>
								...
								<th  class="align-middle text-center text-success">OB_NEW_FP</th>
								<th  class="align-middle text-center text-success">NEW_FPP</th>
								<th  class="align-middle text-center text-success">DRJ_NEW_FPP</th>
								<th  class="align-middle text-center text-success">CRJ_NEW_FPP</th>
								<th  class="align-middle text-center text-success">PAID_NEW_FPP</th>
								<th  class="align-middle text-center text-success">CB_NEW_FPP</th>
								<th  class="align-middle text-center text-danger">OB_CCLPC</th>
								<th  class="align-middle text-center text-danger">CCLPC</th>
								<th  class="align-middle text-center text-danger">RJ_CCLPC</th>
								<th  class="align-middle text-center text-danger ">CB_CCLPC</th>
							</tr>
						</thead>
						<tbody>
							<c:forEach var="mtrblc" items="${ledgerhist}" varStatus="tagStatus">
								<tr>
									...
									<td class="text-right">${mtrblc.OB_EC}</td>
									<td class="text-right">${mtrblc.OB_ED}</td>
									<td class="text-right">${mtrblc.OB_LPC}</td>
									<td class="text-right">${mtrblc.OB_EDI}</td>
									<td class="text-right">${mtrblc.OB_TUPC}</td>
									<td class="text-right">${mtrblc.OB_OLD_FPP}</td>
									<td class="text-right">${mtrblc.OB_NEW_FPP}</td>
									<td class="text-right">${mtrblc.OB_FSA}</td>
									...
									<td class="text-right">${mtrblc.EDI}</td>
									<td class="text-right">${mtrblc.TUPC}</td>
									<td class="text-right">${mtrblc.OLD_FPP}</td>
									<td class="text-right">${mtrblc.NEW_FPP}</td>
									<td class="text-right">${mtrblc.FSA}</td>
									<td class="text-right">${mtrblc.CMD}</td>
									<td class="text-right">${mtrblc.DRJ_EC}</td>
									<td class="text-right">${mtrblc.DRJ_ED}</td>
									<td class="text-right">${mtrblc.DRJ_LPC}</td>
									<td class="text-right">${mtrblc.DRJ_IED}</td>
									<td class="text-right">${mtrblc.DRJ_FSA}</td>
									<td class="text-right">${mtrblc.DRJ_TUPC}</td>
									<td class="text-right">${mtrblc.FPPCA-1}</td>
									<td class="text-right">${mtrblc.FPPCA-2}</td>
									<td class="text-right">${mtrblc.PAID_FSA}</td>
									<td class="text-right">${mtrblc.Total_DRJ}</td>
									<td class="text-right">${mtrblc.CRJ_EC}</td>
									<td class="text-right">${mtrblc.CRJ_ED}</td>
									<td class="text-right">${mtrblc.CRJ_LPC}</td>
									<td class="text-right">${mtrblc.CRJ_IED}</td>
									<td class="text-right">${mtrblc.CRJ_FSA}</td>
									<td class="text-right">${mtrblc.TRUE_UP}</td>
									<td class="text-right">${mtrblc.FPPCA-1}</td>
									<td class="text-right">${mtrblc.FPPCA-2}</td>
									<td class="text-right">${mtrblc.Total_CRJ}</td>
									<td class="text-right">${mtrblc.PAID_EC}</td>
									<td class="text-right">${mtrblc.PAID_ED}</td>
									<td class="text-right">${mtrblc.PAID_LPC}</td>
									<td class="text-right">${mtrblc.PAID_EDI}</td>
									<td class="text-right">${mtrblc.PAID_FSA}</td>
									<td class="text-right">${mtrblc.PAID_TUPC}</td>
									<td class="text-right">${mtrblc.FPPCA-1}</td>
									<td class="text-right">${mtrblc.FPPCA-2}</td>
									<td class="text-right">${mtrblc.TOT_PAY}</td>
									<td class="text-right">${mtrblc.CB_EC}</td>
									<td class="text-right">${mtrblc.CB_LPC}</td>
									<td class="text-right">${mtrblc.CB_ED}</td>
									<td class="text-right">${mtrblc.CB_IED}</td>
									<td class="text-right">${mtrblc.CB_FSA}</td>
									<td class="text-right">${mtrblc.CB_TUPC}</td>
									<td class="text-right">${mtrblc.CB_OLD_FPP}</td>
									<td class="text-right">${mtrblc.CB_NEW_FPP}</td>
									<td class="text-right">${mtrblc.CBTOT}</td>
									<td class="text-right">${mtrblc.OB_SD}</td>
									<td class="text-right">${mtrblc.PAID_SD}</td>
									<td class="text-right">${mtrblc.DRJ_SD}</td>
									<td class="text-right">${mtrblc.CRJ_SD}</td>
									<td class="text-right">${mtrblc.CB_SD}</td>
									<td class="text-right">${mtrblc.OB_TUPC}</td>
									<td class="text-right">${mtrblc.TUPC}</td>
									<td class="text-right">${mtrblc.DRJ_TUPC}</td>
									<td class="text-right">${mtrblc.CRJ_TUPC}</td>
									<td class="text-right">${mtrblc.PAID_TUPC}</td>
									<td class="text-right">${mtrblc.CB_TUPC}</td>
									<td class="text-right">${mtrblc.OB_OLD_FPP}</td>
									<td class="text-right">${mtrblc.OLD_FPP}</td>
									<td class="text-right">${mtrblc.DRJ_OLD_FPP}</td>
									<td class="text-right">${mtrblc.CRJ_OLD_FPP}</td>
									<td class="text-right">${mtrblc.PAID_OLD_FPP}</td>
									<td class="text-right">${mtrblc.CB_OLD_FPP}</td>
									<td class="text-right">${mtrblc.OB_NEW_FPP}</td>
									<td class="text-right">${mtrblc.NEW_FPP}</td>
									<td class="text-right">${mtrblc.DRJ_NEW_FPP}</td>
									<td class="text-right">${mtrblc.CRJ_NEW_FPP}</td>
									<td class="text-right">${mtrblc.PAID_NEW_FPP}</td>
									<td class="text-right">${mtrblc.CB_NEW_FPP}</td>
									<td class="text-right">${mtrblc.OB_CCLPC}</td>
